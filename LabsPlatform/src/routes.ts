...
<<<<<<< HEAD:LabsPlatform/src/routes.ts
...
>>>>>>> origin/master:front-end/LabsPlatform/src/routes.ts
...
export const ROUTER:Routes = [
    ...
    {path:"workshopDetail", component: WorkshopDetailComponentComponent, pathMatch:"full"},
